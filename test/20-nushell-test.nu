...
http get "http://10.178.252.176:3000/wf_process?select=name,description,wf_process_type(name)"
...
http get "http://10.178.252.176:3000/wf_process?select=name,description,...wf_process_type(process_type:name)" | to json
